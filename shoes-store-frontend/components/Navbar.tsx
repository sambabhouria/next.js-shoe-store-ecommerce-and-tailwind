    ...
    <nav className=" bg-white border-[1px] border-[#dbdbdb] ">
      <div className="max-w-[1124px] m-auto p-3 py-6 flex items-center justify-between flex-wrap">
        ...
        <Bars3Icon
          ...
          className="w-11 h-11 cursor-pointer md:hidden"
        />
        <ul className="hidden flex-col md:flex-row links md:flex items-center gap-x-8  w-full md:w-fit links transition-all">
          <li className="mt-6 md:mt-0">
            <Link
              className={`flex items-center text-2xl gap-x-2 font-semibold text-[${
                router.asPath === "/products" ? "black" : "#71717A"
              }] transition-all `}
              href="/products"
            >
          ...
          {currentUser && (
            <>
              <li className="mt-6 md:mt-0">
                <Link
                  className={`text-[${
                    router.asPath === "/wishlist" ? "black" : "#71717A"
                  }]  flex items-center text-2xl gap-x-2 font-semibold`}
                  href="/wishlist"
                >
              ...
              <li
                className="relative mt-6 md:mt-0 w-fit"
              ...
              >
                ...
                {cartItems.length > 0 && (
                  <span className="absolute -top-4 -right-3 bg-red-400 text-lg rounded-full w-[20px] h-[20px] text-white grid place-items-center">
                    {cartItems.length}
                  </span>
                )}
              </li>
